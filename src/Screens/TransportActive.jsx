...
export default function TransportActive({ navigation }) {
    ...
    return (
        ...
        >
            ...
            <View style={tw`flex-row border-b border-gray-200 px-5`}>
                ...
                <TouchableOpacity
                    style={tw`flex-1 py-2`}
                    onPress={() => navigation.navigate("TransportCompleted")}
                >
                    <Text style={tw`text-center text-gray-500`}>Completed(1)</Text>
                </TouchableOpacity>
            </View>
            ...
            <ScrollView style={tw`bg-gray-100 p-5`}>
                {[1, 2].map((item, index) => (
                    <View
                        key={index}
                        style={tw`bg-white rounded-lg shadow p-5 mb-5`}
                    >
                        {/* Title Row */}
                        <View style={tw`flex-row justify-between items-center`}>
                            ...
                            <Text style={tw`bg-blue-500 text-white px-3 py-1 rounded text-xs`}>
                                In Transit
                            </Text>
                        </View>
                        ...
                        <View>
                            ...
                            <Text style={tw`text-gray-500`}>● Melbourne Delivery - 16:45</Text>
                        </View>
                    </View>
                ))}
            </ScrollView>
