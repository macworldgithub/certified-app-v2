...
//                   )}
//                   onPress={() => handleSelect("tyreConditionFrontLeft", option)}
//                 >
...
//               style={tw`w-16 h-16 mt-2 self-end`}
//               resizeMode="contain"
//             />
//           </View>
...
//                       : "border-gray-300 bg-white"
//                   )}
//                   onPress={() => handleSelect("tyreConditionRearRight", option)}
//                 >
//                   <Text style={tw`text-gray-700`}>{option}</Text>
//                 </TouchableOpacity>
//               ))}
...
//                       : "border-gray-300 bg-white"
//                   )}
//                   onPress={() => handleSelect("tyreConditionRearLeft", option)}
//                 >
//                   <Text style={tw`text-gray-700`}>{option}</Text>
//                 </TouchableOpacity>
//               ))}
