...
export default function BodyChecklist({ navigation }) {
  ...
  const redux_body = useSelector((state) => state.inspection.body);
  ...
  const [body, setBodyState] = useState(redux_body);
  ...
  return (
    <SafeAreaWrapper>
      <ScrollView style={tw`flex-1 bg-white p-3`}>
        ...
        <Header title="Body Inspection" onBack={handleBack} />
          ...
          <>
            {renderDropdown(
              ...
              (v) =>
                setBodyState({
                  ...body,
                  panels: { ...body?.panels, condition: v },
                }),
            ...
            {renderInput(
              ...
              (v) =>
                setBodyState({
                  ...body,
                  panels: { ...body?.panels, dentsCount: v },
                }),
              true
            )}
            {renderDropdown(
              ...
              body?.panels?.rust,
              (v) =>
                setBodyState({ ...body, panels: { ...body?.panels, rust: v } }),
              ["Yes", "No", "Unknown"]
            )}
            {renderDropdown(
              "Alignment",
              ...
              (v) =>
                setBodyState({
                  ...body,
                  panels: { ...body?.panels, alignment: v },
                }),
          ...
          <>
            ...
            {renderDropdown(
              ...
              (v) =>
                setBodyState({
                  ...body,
                  doors: { ...body?.doors, closingEffort: v },
                }),
              ["Light", "Normal", "Hard"]
            )}
          ...
          <>
            ...
            {renderDropdown(
              ...
              (v) =>
                setBodyState({
                  ...body,
                  glass: { ...body?.glass, tintCondition: v },
                }),
              ["Good", "Fair", "Poor", "Damaged", "NotApplicable"]
            )}
          </>
          ...
          <>
            {renderDropdown(
              ...
              (v) =>
                setBodyState({
                  ...body,
                  mirrors: { ...body?.mirrors, condition: v },
                }),
              ["Good", "Fair", "Poor", "Damaged", "NotApplicable"]
            )}
            {renderDropdown(
              ...
              (v) =>
                setBodyState({
                  ...body,
                  mirrors: { ...body?.mirrors, severity: v },
                }),
              ["None", "Minor", "Moderate", "Severe"]
            )}
          ...
          <>
            ...
            {renderDropdown(
              ...
              (v) =>
                setBodyState({
                  ...body,
                  interior: { ...body?.interior, severity: v },
                }),
              ["None", "Minor", "Moderate", "Severe"]
            )}
            {renderInput("Notes", body?.interior?.notes, (v) =>
              setBodyState({
                ...body,
                interior: { ...body?.interior, notes: v },
              })
            )}
            {renderDropdown(
              "Cleanliness",
        ...
        {renderSection(
          ...
          <>
            ...
            {renderInput("Frayed", body?.seatBelts?.frayed, (v) =>
              setBodyState({
                ...body,
                seatBelts: { ...body?.seatBelts, frayed: v },
              })
            )}
            {renderInput("Notes", body?.seatBelts?.notes, (v) =>
              setBodyState({
                ...body,
                seatBelts: { ...body?.seatBelts, notes: v },
              })
            )}
          </>
        )}
        ...
        {renderSection(
          ...
          <>
            ...
            {renderInput(
              "Description",
              body?.repairEvidence?.description,
              (v) =>
                setBodyState({
                  ...body,
